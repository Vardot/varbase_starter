...
console.log('📋 This script copies files from node_modules/ to web/libraries/ as configured in package.json');
...
const fallbackTargets = ['web/libraries', 'docroot/libraries', 'public_html/libraries', 'www/libraries', 'htdocs/libraries', 'html/libraries', 'libraries'];
