...
Guidance for AI coding agents working on the Varbase Starter recipe.
...
- **Merge request comments and history** on
  [git.drupalcode.org/project/varbase_starter](https://git.drupalcode.org/project/varbase_starter/-/merge_requests)
  — the reasoning behind recent changes lives in the MR discussions.
- **Issue comments** on
  [drupal.org/project/issues/varbase_starter](https://www.drupal.org/project/issues/varbase_starter)
